                        ...
                        <nav class="navbar navbar-inverse" style="padding-right: 10px">
                            <div class="container-fluid">
                                <ul class="nav navbar-nav">
                                    ...
                                    <li  class="active"><a href="../UI/ShowExpensesByDate_new.aspx">Show Expense</a></li>
                                ...
                                <div class="panel panel-body">
                                    <div class="form-inline">
                                        ...
                                        <div class="col-md-10 col-xs-10 col-xs-offset-1 padding-bottom-10">
                                            ...
                                            <asp:Button ID="printExpenseButton" CssClass="btn btn-default" runat="server" Text="print Expense" OnClick="printExpenseButton_Click" />
                                        </div>
                                    </div>
