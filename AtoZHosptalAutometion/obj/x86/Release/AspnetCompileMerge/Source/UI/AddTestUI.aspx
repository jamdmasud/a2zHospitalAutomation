<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="AddTestUI.aspx.cs" Inherits="AtoZHosptalAutometion.UI.AddTestUI" %>
                                ...
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Store <span class="caret"></span></a>
                                        <ul class="dropdown-menu">
                                            ...
                                            <li class="active"><a href="../UI/AddTestUI.aspx">Save Pathology Test</a></li>
                                        </ul>
                                    </li>
                                ...
                                <div class="panel panel-success">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="col-xs-10 col-sm-10 col-md-10 col-xs-offset-1">
                                            <label class="col-md-4 col-xs-4 control-label">Test Name: </label>
