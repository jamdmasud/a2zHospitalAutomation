                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="col-md-12 col-sm-12 col-xs-12">
                                    <a href="/UI/DailyCashDipositUI.aspx">
                                        <div class="col-md-3 col-sm-3 col-xs-3 btn btn-default" style="margin: 10px; text-align: center; height: 100px; padding-top: 35px">
                                            <span class="glyphicon glyphicon-th-large ico"></span>Daily Diposit
                                        </div>
                                    </a>
                                    <a href="/UI/MedicineSaleListUI.aspx">
                                        <div class="col-md-3 col-sm-3 col-xs-3 btn btn-default" style="margin: 10px; height: 100px; padding-top: 35px">
                                            <span class="glyphicon glyphicon-random ico"></span>Medicine Sold 
                                        </div>
                                    </a>
                                    <a href="/UI/ServiceSaleListUI.aspx">
                                        <div class="col-md-3 col-sm-3 col-xs-3 btn btn-default" style="margin: 10px; height: 100px; padding-top: 35px">
                                            <span class="glyphicon glyphicon-random ico"></span>Service Sold
                                        </div>
                                    </a>
                                    <a href="/UI/ShowExpensesByDate_new.aspx">
                                    ...
                                    <a href="/UI/DueListUI.aspx">
                                        <div class="col-md-3 col-sm-3 col-xs-3 btn btn-default" style="margin: 12px; text-align: center; height: 100px; padding-top: 35px">
                                            <span class="glyphicon glyphicon-yen ico"></span>Due Collection
                                        </div>
                                    </a>
                                    <a href="/UI/AgentPayment.aspx">
                                        <div class="col-md-3 col-sm-3 col-xs-3 btn btn-default" style="margin: 12px; height: 100px; padding-top: 35px">
