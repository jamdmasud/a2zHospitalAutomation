<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="SalesMedicineUI.aspx.cs" Inherits="AtoZHosptalAutometion.UI.SalesMedicineUI" %>
                    ...
                    <div class="panel-body">
                        ...
                        <asp:Table ID="Table1" runat="server">
                            <asp:TableRow runat="server">
                                <asp:TableCell runat="server">Medicine</asp:TableCell>
                                ...
                                <asp:TableCell runat="server">Operation</asp:TableCell>
                            </asp:TableRow>
                        </asp:Table>
