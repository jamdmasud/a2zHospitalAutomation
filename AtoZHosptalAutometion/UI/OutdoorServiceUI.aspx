<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="OutdoorServiceUI.aspx.cs" Inherits="AtoZHosptalAutometion.UI.OutdoorServiceUI" %>
    ...
    <script type="text/javascript">
        ...
        function BindGridview() {
            $.ajax({
                ...
                url: "OutdoorServiceUI.aspx/BindGridview",
                data: "{}",
                dataType: "json",
        ...
        function ConvertNumberToWor(tot) {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "OutdoorServiceUI.aspx/ConvertToString",
                data: "{'data':'" + tot + "'}",
                dataType: "json",
                success: function (data) {
                    var result = data.d;
        ...
        function GetRate(rate) {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "OutdoorServiceUI.aspx/GetProductRate",
        ...
        function insertupdatedata(id, particular, quantity, rate, total, status) {
            ...
            $.ajax({
                type: "POST",
                contentType: "application/json; charset=utf-8",
                url: "OutdoorServiceUI.aspx/crudoperations",
                                ...
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Services<span class="caret"></span></a>
                                        <ul class="dropdown-menu">
                                            ...
                                            <li class="active"><a href="../UI/OutdoorServiceUI.aspx">Outdoor Service</a></li>
                                        </ul>
                                    </li>
                            ...
                            <div class="row">
                                <div class="panel panel-success">
                                    <div class="panel-heading">
                                        <p class="panel-title">Outdoor Bill</p>
                                    </div>
                                            ...
                                            <div class="form-inline">
                                                <div class="form-group padding-bottom-10">
                                                    ...
                                                    <cc1:AutoCompleteExtender ServiceMethod="SearchPatient"
                                                        ...
                                                        TargetControlID="patientBox"
                                                        ID="AutoCompleteExtender2" runat="server" FirstRowSelected="false">
                                                    </cc1:AutoCompleteExtender>
                                                </div>
                                                <div class="form-group padding-bottom-10">
                                                    <label class="control-label" for="#doctorBox">Doctor</label>
                                                    <asp:TextBox ID="doctorBox" placeholder="Doctor Name" CssClass="form-control" runat="server"></asp:TextBox>
                                                    <cc1:AutoCompleteExtender ServiceMethod="SearchDoctor"
                                                        MinimumPrefixLength="1"
                                                        CompletionInterval="100" EnableCaching="false" CompletionSetCount="10"
                                                        TargetControlID="doctorBox"
                                                ...
                                                <table class="table table-responsive table-condensed">
                                                    <tr>
                                                     ...
                                                     <tr>
                                                        ...
                                                        <td><input type="text" runat="server" id="txtVat" value="0" readonly="readonly"/></td>
                                                    </tr>
                                                    <tr>
                                                        <td>Discount: </td>
                                                        <td><input type="text" runat="server" value="0" id="txtDiscount"/></td>
                                                    </tr>
                                                     <tr>
                                                        <td>Grand Total: </td>
                                                        <td><input type="text" runat="server" id="txtGrandTotal" value="0" readonly="readonly"/></td>
                                                    </tr>
                                                     <tr>
                                                        <td>Advance: </td>
                                                        <td><input type="text" runat="server" value="0" id="txtAdvance"/></td>
                                                    </tr>
                                                     <tr>
                                                        <td>Due: </td>
                                                        <td><input type="text" runat="server" id="txtDue" value="0" readonly="readonly"/></td>
                                                    </tr>
                                                    <tr>
                                                        <td>AgentId</td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td>Amount:</td>
                                                        <td><input type="text" runat="server" value="0" id="txtHonorarium"/></td>
                                                    </tr>
                                                </table>
                                            </div>
                                        </div>
                                        <asp:Button runat="server" ID="submitButton" Text="Submit" CssClass="btn btn-success btn-block" OnClick="submitButton_Click" />
                                        <asp:Button ID="printButton" runat="server" CssClass="btn btn-info btn-block" Visible="False" Text="Print Report" />
                                    </div>
                                </div>
                            </div>
                        </div>
