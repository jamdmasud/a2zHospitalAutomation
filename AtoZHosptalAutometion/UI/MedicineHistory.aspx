<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MedicineHistory.aspx.cs" Inherits="AtoZHosptalAutometion.UI.MedicineHistory" %>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-9" style="padding: 0">
                                ...
                                <ul class="nav navbar-nav">
                                    ...
                                    <li class="dropdown"><a class="dropdown-toggle" data-toggle="dropdown" href="#">Management <span class="caret"></span></a>
                                        <ul class="dropdown-menu">
                                            ...
                                            <li class="active"><a href="../UI/MedicineSearch.aspx">Search Medicine</a></li>
                        ...
                        <!--test Navbar end-->
                        <!--content start-->
                        <h3 class="alert alert-info text-capitalize text-success">
                                <strong>Medicine Name: </strong><span>
                                    <asp:Label ID="medicineNameLabel" runat="server" Text="Label"></asp:Label></span>
                        </h3>
