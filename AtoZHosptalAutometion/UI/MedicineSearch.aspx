<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MedicineSearch.aspx.cs" Inherits="AtoZHosptalAutometion.UI.MedicineSearch" %>
                    ...
                    <div class="col-md-9 col-sm-9 col-xs-9" style="padding: 0">
                        ...
                        <div class="col-md-10 col-sm-10 col-xs-10 col-md-offset-1 col-sm-offset-1 col-xs-offset-1">
                            <div class="form-group col-md-10 col-sm-10">
                                Searcha Medicine: 
                                <asp:TextBox ID="searcgTextBox" CssClass="form-control col-md-6 col-sm-6" runat="server">
                                </asp:TextBox>
                                <br />
                                <asp:Button ID="searchButton" CssClass="btn btn-success btn-block  col-md-4 col-sm-4" runat="server" Text="Search" OnClick="searchButton_Click" />
                            </div>
